...
const traerSugerencias = async letras => {
	const url = `https://api.giphy.com/v1/tags/related/${letras}?api_key=1VWPQGJNKdbCGhUfblNItlx8tPK2xKS3&lang=es`;
...
async function mostrarBusqueda(texto){
	...
	let url = 'https://api.giphy.com/v1/gifs/search?api_key=1VWPQGJNKdbCGhUfblNItlx8tPK2xKS3&q='+texto+'&limit=&offset=0&rating=g&lang=es'
